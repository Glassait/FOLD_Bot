 ...
 */
export function getPreviousMonthAsDate(): Date {
    const date = new Date();
...
export function getCurrentMonth(): string {
    return convertDateToMonthYearString(new Date());
}
 ...
 */
export function convertDateToMonthYearString(date: Date): string {
 ...
 */
export function getPreviousDayAsDate(): Date {
...
/**
     ...
     */
export function diffOfDay(date1: Date, date2: Date): number {
